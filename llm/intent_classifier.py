...
CLASSIFY_PROMPT = """\
You are a strict intent classifier. Your only job is to read a user message and return exactly one label.
...
def classify_intent(user_message: str) -> str:
    """Classify user message into an intent category using Ollama.
